////////////////////////////////////////////////////////////////////
//DeRap: Ammo\145x114_Snafu\config.bin
...
class CfgPatches
{
	class Fresh_AmmoBox_SNAFU_145x114
	{
		units[] = {"Fresh_AmmoBox_145x114_10Rnd"};
		weapons[] = {};
		requiredVersion = 0.1;
...
{
	class Box_Base;
	class Fresh_AmmoBox_145x114_10Rnd: Box_Base
	{
		scope = 2;
		displayName = "145x114 AmmoBox";
		descriptionShort = "A box of 10 145x114 rounds.";
		model = "\dz\weapons\ammunition\762_20RoundBox.p3d";
		itemSize[] = {1,1};
		rotationFlags = 17;
		weight = 600;
		hiddenSelections[] = {"zbytek","camoground"};
		hiddenSelectionsTextures[] = {"CA_Override\Ammo\145x114_Snafu\data\SNAFU_145x114_box_co.paa","CA_Override\Ammo\145x114_Snafu\data\SNAFU_145x114_box_co.paa"};
		class DamageSystem
		{
			class GlobalHealth
			{
